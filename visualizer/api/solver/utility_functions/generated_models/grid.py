...
pi0>=3, pi1>=2, pi2>=2, pi3>=2, pi4>=1, pi5>=1, pi6>=1, pi7>=0, pi8>=0, 
...
pi7 == 0, 
pi8 == (ys8_1*xo1l + ys8_2*xo2l) * (1 + pi7) + (ys8_1*xo1r + ys8_2*xo2r) * (1 + pi8) + (ys8_1*xo1u + ys8_2*xo2u) * (1 + pi5) + (ys8_1*xo1d + ys8_2*xo2d) * (1 + pi8),
exp==((pi0+pi1+pi2+pi3+pi4+pi5+pi6+pi8)) * Q(1,8),
