...
pi0>=31, pi1>=30, pi2>=29, pi3>=28, pi4>=27, pi5>=26, pi6>=25, pi7>=24, pi8>=23, pi9>=22, pi10>=21, pi11>=20, pi12>=19, pi13>=18, pi14>=17, pi15>=16, pi16>=15, pi17>=14, pi18>=13, pi19>=12, pi20>=11, pi21>=10, pi22>=9, pi23>=8, pi24>=7, pi25>=6, pi26>=5, pi27>=4, pi28>=3, pi29>=2, pi30>=1, pi31>=0, pi32>=1, pi33>=2, pi34>=3, pi35>=4, pi36>=5, pi37>=6, pi38>=7, pi39>=8, pi40>=9, pi41>=10, pi42>=11, pi43>=12, pi44>=13, pi45>=14, pi46>=15, pi47>=16, pi48>=17, pi49>=18, pi50>=19, pi51>=20, pi52>=21, pi53>=22, pi54>=23, pi55>=24, pi56>=25, pi57>=26, pi58>=27, pi59>=28, pi60>=29, pi61>=30, pi62>=31, 
...
pi62== ((1 - y62)*xol + y62*xo62l) * (1 + pi61) + ((1 - y62)*xor + y62*xo62r) * (1 + pi62), 
# We are dropped uniformly in the line
# We want to check if the minimal expected cost is below some threshold <= 16
() * Q(1,62) <= 16,
...
Or (y61 == 0 , y61 == 1 ),
Or (y62 == 0 , y62 == 1 ),
y0 + y1 + y2 + y3 + y4 + y5 + y6 + y7 + y8 + y9 + y10 + y11 + y12 + y13 + y14 + y15 + y16 + y17 + y18 + y19 + y20 + y21 + y22 + y23 + y24 + y25 + y26 + y27 + y28 + y29 + y30 + y32 + y33 + y34 + y35 + y36 + y37 + y38 + y39 + y40 + y41 + y42 + y43 + y44 + y45 + y46 + y47 + y48 + y49 + y50 + y51 + y52 + y53 + y54 + y55 + y56 + y57 + y58 + y59 + y60 + y61 + y62 == 31
)
if solver.check() == sat:
	m = solver.model()
