...
pi0>=3, pi1>=2, pi2>=1, pi3>=2, pi4>=3, pi5>=4, pi6>=0, pi7>=4, 
...
pi4 == (ys4_1*xo1l + ys4_2*xo2l) * (1 + pi3) + (ys4_1*xo1r + ys4_2*xo2r) * (1 + pi4) + (ys4_1*xo1u + ys4_2*xo2u) * (1 + pi4) + (ys4_1*xo1d + ys4_2*xo2d) * (1 + pi7),
pi5 == (ys5_1*xo1l + ys5_2*xo2l) * (1 + pi5) + (ys5_1*xo1r + ys5_2*xo2r) * (1 + pi5) + (ys5_1*xo1u + ys5_2*xo2u) * (1 + pi0) + (ys5_1*xo1d + ys5_2*xo2d) * (1 + pi5),
pi6 == 0, 
pi7 == (ys7_1*xo1l + ys7_2*xo2l) * (1 + pi7) + (ys7_1*xo1r + ys7_2*xo2r) * (1 + pi7) + (ys7_1*xo1u + ys7_2*xo2u) * (1 + pi4) + (ys7_1*xo1d + ys7_2*xo2d) * (1 + pi7),
# We are dropped uniformly in the grid
# We want to check if the minimal expected cost is below some threshold <= 3
(pi0+pi1+pi2+pi3+pi4+pi5+pi7) * Q(1,7) <= 3,
