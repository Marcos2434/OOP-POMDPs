...
pi0>=2, pi1>=1, pi2>=2, pi3>=3, pi4>=1, pi5>=3, 
...
pi3 == (ys3_1*xo1l + ys3_2*xo2l) * (1 + pi3) + (ys3_1*xo1r + ys3_2*xo2r) * (1 + pi3) + (ys3_1*xo1u + ys3_2*xo2u) * (1 + pi0) + (ys3_1*xo1d + ys3_2*xo2d) * (1 + pi3),
pi4 == (ys4_1*xo1l + ys4_2*xo2l) * (1 + pi4) + (ys4_1*xo1r + ys4_2*xo2r) * (1 + pi4) + (ys4_1*xo1u + ys4_2*xo2u) * (1 + pi1) + (ys4_1*xo1d + ys4_2*xo2d) * (1 + pi4),
pi5 == (ys5_1*xo1l + ys5_2*xo2l) * (1 + pi5) + (ys5_1*xo1r + ys5_2*xo2r) * (1 + pi5) + (ys5_1*xo1u + ys5_2*xo2u) * (1 + pi2) + (ys5_1*xo1d + ys5_2*xo2d) * (1 + pi5),
# We are dropped uniformly in the grid
# We want to check if the minimal expected cost is below some threshold <= 2.25
(pi0+pi1+pi2+pi3+pi4+pi5) * Q(1,5) <= 2.25,
