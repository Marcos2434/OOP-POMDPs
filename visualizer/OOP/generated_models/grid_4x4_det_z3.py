...
# We want to check if the minimal expected cost is below some threshold <= 200
(pi0+pi1+pi2+pi3+pi4+pi5+pi6+pi7+pi8+pi10+pi11+pi12+pi13+pi14+pi15) * Q(1,15) <= 200,
