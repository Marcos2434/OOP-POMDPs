...
pi0>=38, pi1>=37, pi2>=36, pi3>=35, pi4>=34, pi5>=33, pi6>=32, pi7>=31, pi8>=30, pi9>=29, pi10>=28, pi11>=27, pi12>=26, pi13>=25, pi14>=24, pi15>=23, pi16>=22, pi17>=21, pi18>=20, pi19>=19, pi20>=20, pi21>=21, pi22>=22, pi23>=23, pi24>=24, pi25>=25, pi26>=26, pi27>=27, pi28>=28, pi29>=29, pi30>=30, pi31>=31, pi32>=32, pi33>=33, pi34>=34, pi35>=35, pi36>=36, pi37>=37, pi38>=38, pi39>=39, pi40>=18, pi41>=39, pi42>=40, pi43>=17, pi44>=40, pi45>=41, pi46>=16, pi47>=41, pi48>=42, pi49>=15, pi50>=42, pi51>=43, pi52>=14, pi53>=43, pi54>=44, pi55>=13, pi56>=44, pi57>=45, pi58>=12, pi59>=45, pi60>=46, pi61>=11, pi62>=46, pi63>=47, pi64>=10, pi65>=47, pi66>=48, pi67>=9, pi68>=48, pi69>=49, pi70>=8, pi71>=49, pi72>=50, pi73>=7, pi74>=50, pi75>=51, pi76>=6, pi77>=51, pi78>=52, pi79>=5, pi80>=52, pi81>=53, pi82>=4, pi83>=53, pi84>=54, pi85>=3, pi86>=54, pi87>=55, pi88>=2, pi89>=55, pi90>=56, pi91>=1, pi92>=56, pi93>=57, pi94>=0, pi95>=57, 
# Expected cost/reard equations
pi0 == (ys01*xo1l + ys02*xo2l + ys03*xo3l + ys04*xo4l) * (1 + pi0) + (ys01*xo1r + ys02*xo2r + ys03*xo3r + ys04*xo4r) * (1 + pi1) + (ys01*xo1u + ys02*xo2u + ys03*xo3u + ys04*xo4u) * (1 + pi0) + (ys01*xo1d + ys02*xo2d + ys03*xo3d + ys04*xo4d) * (1 + pi39),
...
pi19 == (ys191*xo1l + ys192*xo2l + ys193*xo3l + ys194*xo4l) * (1 + pi18) + (ys191*xo1r + ys192*xo2r + ys193*xo3r + ys194*xo4r) * (1 + pi20) + (ys191*xo1u + ys192*xo2u + ys193*xo3u + ys194*xo4u) * (1 + pi19) + (ys191*xo1d + ys192*xo2d + ys193*xo3d + ys194*xo4d) * (1 + pi40),
pi20 == (ys201*xo1l + ys202*xo2l + ys203*xo3l + ys204*xo4l) * (1 + pi19) + (ys201*xo1r + ys202*xo2r + ys203*xo3r + ys204*xo4r) * (1 + pi21) + (ys201*xo1u + ys202*xo2u + ys203*xo3u + ys204*xo4u) * (1 + pi20) + (ys201*xo1d + ys202*xo2d + ys203*xo3d + ys204*xo4d) * (1 + pi20),
...
pi38 == (ys381*xo1l + ys382*xo2l + ys383*xo3l + ys384*xo4l) * (1 + pi37) + (ys381*xo1r + ys382*xo2r + ys383*xo3r + ys384*xo4r) * (1 + pi38) + (ys381*xo1u + ys382*xo2u + ys383*xo3u + ys384*xo4u) * (1 + pi38) + (ys381*xo1d + ys382*xo2d + ys383*xo3d + ys384*xo4d) * (1 + pi41),
pi39 == (ys391*xo1l + ys392*xo2l + ys393*xo3l + ys394*xo4l) * (1 + pi39) + (ys391*xo1r + ys392*xo2r + ys393*xo3r + ys394*xo4r) * (1 + pi39) + (ys391*xo1u + ys392*xo2u + ys393*xo3u + ys394*xo4u) * (1 + pi0) + (ys391*xo1d + ys392*xo2d + ys393*xo3d + ys394*xo4d) * (1 + pi42),
pi40 == (ys401*xo1l + ys402*xo2l + ys403*xo3l + ys404*xo4l) * (1 + pi40) + (ys401*xo1r + ys402*xo2r + ys403*xo3r + ys404*xo4r) * (1 + pi40) + (ys401*xo1u + ys402*xo2u + ys403*xo3u + ys404*xo4u) * (1 + pi19) + (ys401*xo1d + ys402*xo2d + ys403*xo3d + ys404*xo4d) * (1 + pi43),
pi41 == (ys411*xo1l + ys412*xo2l + ys413*xo3l + ys414*xo4l) * (1 + pi41) + (ys411*xo1r + ys412*xo2r + ys413*xo3r + ys414*xo4r) * (1 + pi41) + (ys411*xo1u + ys412*xo2u + ys413*xo3u + ys414*xo4u) * (1 + pi38) + (ys411*xo1d + ys412*xo2d + ys413*xo3d + ys414*xo4d) * (1 + pi44),
pi42 == (ys421*xo1l + ys422*xo2l + ys423*xo3l + ys424*xo4l) * (1 + pi42) + (ys421*xo1r + ys422*xo2r + ys423*xo3r + ys424*xo4r) * (1 + pi42) + (ys421*xo1u + ys422*xo2u + ys423*xo3u + ys424*xo4u) * (1 + pi39) + (ys421*xo1d + ys422*xo2d + ys423*xo3d + ys424*xo4d) * (1 + pi45),
...
pi93 == (ys931*xo1l + ys932*xo2l + ys933*xo3l + ys934*xo4l) * (1 + pi93) + (ys931*xo1r + ys932*xo2r + ys933*xo3r + ys934*xo4r) * (1 + pi93) + (ys931*xo1u + ys932*xo2u + ys933*xo3u + ys934*xo4u) * (1 + pi90) + (ys931*xo1d + ys932*xo2d + ys933*xo3d + ys934*xo4d) * (1 + pi93),
pi94 == 0, 
pi95 == (ys951*xo1l + ys952*xo2l + ys953*xo3l + ys954*xo4l) * (1 + pi95) + (ys951*xo1r + ys952*xo2r + ys953*xo3r + ys954*xo4r) * (1 + pi95) + (ys951*xo1u + ys952*xo2u + ys953*xo3u + ys954*xo4u) * (1 + pi92) + (ys951*xo1d + ys952*xo2d + ys953*xo3d + ys954*xo4d) * (1 + pi95),
# We are dropped uniformly in the grid
# We want to check if the minimal expected cost is below some threshold <=Q(3116,95)
() * Q(1,95) <=Q(3116,95),
