...
pi0>=189, pi1>=188, pi2>=187, pi3>=186, pi4>=185, pi5>=184, pi6>=183, pi7>=182, pi8>=181, pi9>=180, pi10>=179, pi11>=178, pi12>=177, pi13>=176, pi14>=175, pi15>=174, pi16>=173, pi17>=172, pi18>=171, pi19>=170, pi20>=169, pi21>=168, pi22>=167, pi23>=166, pi24>=165, pi25>=164, pi26>=163, pi27>=162, pi28>=161, pi29>=160, pi30>=159, pi31>=158, pi32>=157, pi33>=156, pi34>=155, pi35>=154, pi36>=153, pi37>=152, pi38>=151, pi39>=150, pi40>=149, pi41>=148, pi42>=147, pi43>=146, pi44>=145, pi45>=144, pi46>=143, pi47>=142, pi48>=141, pi49>=140, pi50>=139, pi51>=138, pi52>=137, pi53>=136, pi54>=135, pi55>=134, pi56>=133, pi57>=132, pi58>=131, pi59>=130, pi60>=129, pi61>=128, pi62>=127, pi63>=126, pi64>=125, pi65>=124, pi66>=123, pi67>=122, pi68>=121, pi69>=120, pi70>=119, pi71>=118, pi72>=117, pi73>=116, pi74>=115, pi75>=114, pi76>=113, pi77>=112, pi78>=111, pi79>=110, pi80>=109, pi81>=108, pi82>=107, pi83>=106, pi84>=105, pi85>=104, pi86>=103, pi87>=102, pi88>=101, pi89>=100, pi90>=99, pi91>=98, pi92>=97, pi93>=96, pi94>=95, pi95>=94, pi96>=93, pi97>=92, pi98>=91, pi99>=90, pi100>=89, pi101>=88, pi102>=87, pi103>=86, pi104>=85, pi105>=84, pi106>=83, pi107>=82, pi108>=81, pi109>=80, pi110>=79, pi111>=78, pi112>=77, pi113>=76, pi114>=75, pi115>=74, pi116>=73, pi117>=72, pi118>=71, pi119>=70, pi120>=69, pi121>=68, pi122>=67, pi123>=66, pi124>=65, pi125>=64, pi126>=63, pi127>=62, pi128>=61, pi129>=60, pi130>=59, pi131>=58, pi132>=57, pi133>=56, pi134>=55, pi135>=54, pi136>=53, pi137>=52, pi138>=51, pi139>=50, pi140>=49, pi141>=48, pi142>=47, pi143>=46, pi144>=45, pi145>=44, pi146>=43, pi147>=42, pi148>=41, pi149>=40, pi150>=39, pi151>=38, pi152>=37, pi153>=36, pi154>=35, pi155>=34, pi156>=33, pi157>=32, pi158>=31, pi159>=30, pi160>=29, pi161>=28, pi162>=27, pi163>=26, pi164>=25, pi165>=24, pi166>=23, pi167>=22, pi168>=21, pi169>=20, pi170>=19, pi171>=18, pi172>=17, pi173>=16, pi174>=15, pi175>=14, pi176>=13, pi177>=12, pi178>=11, pi179>=10, pi180>=9, pi181>=8, pi182>=7, pi183>=6, pi184>=5, pi185>=4, pi186>=3, pi187>=2, pi188>=1, pi189>=0, pi190>=1, pi191>=2, pi192>=3, pi193>=4, pi194>=5, pi195>=6, pi196>=7, pi197>=8, pi198>=9, pi199>=10, pi200>=11, pi201>=12, pi202>=13, pi203>=14, pi204>=15, pi205>=16, pi206>=17, pi207>=18, pi208>=19, pi209>=20, pi210>=21, pi211>=22, pi212>=23, pi213>=24, pi214>=25, pi215>=26, pi216>=27, pi217>=28, pi218>=29, pi219>=30, pi220>=31, pi221>=32, pi222>=33, pi223>=34, pi224>=35, pi225>=36, pi226>=37, pi227>=38, pi228>=39, pi229>=40, pi230>=41, pi231>=42, pi232>=43, pi233>=44, pi234>=45, pi235>=46, pi236>=47, pi237>=48, pi238>=49, pi239>=50, pi240>=51, pi241>=52, pi242>=53, pi243>=54, pi244>=55, pi245>=56, pi246>=57, pi247>=58, pi248>=59, pi249>=60, pi250>=61, pi251>=62, pi252>=63, pi253>=64, pi254>=65, pi255>=66, pi256>=67, pi257>=68, pi258>=69, pi259>=70, pi260>=71, pi261>=72, pi262>=73, pi263>=74, pi264>=75, pi265>=76, pi266>=77, pi267>=78, pi268>=79, pi269>=80, pi270>=81, pi271>=82, pi272>=83, pi273>=84, pi274>=85, pi275>=86, pi276>=87, pi277>=88, pi278>=89, pi279>=90, pi280>=91, pi281>=92, pi282>=93, pi283>=94, pi284>=95, pi285>=96, pi286>=97, pi287>=98, pi288>=99, pi289>=100, pi290>=101, pi291>=102, pi292>=103, pi293>=104, pi294>=105, pi295>=106, pi296>=107, pi297>=108, pi298>=109, pi299>=110, pi300>=111, pi301>=112, pi302>=113, pi303>=114, pi304>=115, pi305>=116, pi306>=117, pi307>=118, pi308>=119, pi309>=120, pi310>=121, pi311>=122, pi312>=123, pi313>=124, pi314>=125, pi315>=126, pi316>=127, pi317>=128, pi318>=129, pi319>=130, pi320>=131, pi321>=132, pi322>=133, pi323>=134, pi324>=135, pi325>=136, pi326>=137, pi327>=138, pi328>=139, pi329>=140, pi330>=141, pi331>=142, pi332>=143, pi333>=144, pi334>=145, pi335>=146, pi336>=147, pi337>=148, pi338>=149, pi339>=150, pi340>=151, pi341>=152, pi342>=153, pi343>=154, pi344>=155, pi345>=156, pi346>=157, pi347>=158, pi348>=159, pi349>=160, pi350>=161, pi351>=162, pi352>=163, pi353>=164, pi354>=165, pi355>=166, pi356>=167, pi357>=168, pi358>=169, pi359>=170, pi360>=171, pi361>=172, pi362>=173, pi363>=174, pi364>=175, pi365>=176, pi366>=177, pi367>=178, pi368>=179, pi369>=180, pi370>=181, pi371>=182, pi372>=183, pi373>=184, pi374>=185, pi375>=186, pi376>=187, pi377>=188, pi378>=189, 
