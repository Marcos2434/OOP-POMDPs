...
pi0>=10, pi1>=9, pi2>=8, pi3>=7, pi4>=6, pi5>=5, pi6>=9, pi7>=8, pi8>=7, pi9>=6, pi10>=5, pi11>=4, pi12>=8, pi13>=7, pi14>=6, pi15>=5, pi16>=4, pi17>=3, pi18>=7, pi19>=6, pi20>=5, pi21>=4, pi22>=3, pi23>=2, pi24>=6, pi25>=5, pi26>=4, pi27>=3, pi28>=2, pi29>=1, pi30>=5, pi31>=4, pi32>=3, pi33>=2, pi34>=1, pi35>=0, # Expected cost/reard equations
