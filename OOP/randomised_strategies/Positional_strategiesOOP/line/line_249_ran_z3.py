...
pi0>=124, pi1>=123, pi2>=122, pi3>=121, pi4>=120, pi5>=119, pi6>=118, pi7>=117, pi8>=116, pi9>=115, pi10>=114, pi11>=113, pi12>=112, pi13>=111, pi14>=110, pi15>=109, pi16>=108, pi17>=107, pi18>=106, pi19>=105, pi20>=104, pi21>=103, pi22>=102, pi23>=101, pi24>=100, pi25>=99, pi26>=98, pi27>=97, pi28>=96, pi29>=95, pi30>=94, pi31>=93, pi32>=92, pi33>=91, pi34>=90, pi35>=89, pi36>=88, pi37>=87, pi38>=86, pi39>=85, pi40>=84, pi41>=83, pi42>=82, pi43>=81, pi44>=80, pi45>=79, pi46>=78, pi47>=77, pi48>=76, pi49>=75, pi50>=74, pi51>=73, pi52>=72, pi53>=71, pi54>=70, pi55>=69, pi56>=68, pi57>=67, pi58>=66, pi59>=65, pi60>=64, pi61>=63, pi62>=62, pi63>=61, pi64>=60, pi65>=59, pi66>=58, pi67>=57, pi68>=56, pi69>=55, pi70>=54, pi71>=53, pi72>=52, pi73>=51, pi74>=50, pi75>=49, pi76>=48, pi77>=47, pi78>=46, pi79>=45, pi80>=44, pi81>=43, pi82>=42, pi83>=41, pi84>=40, pi85>=39, pi86>=38, pi87>=37, pi88>=36, pi89>=35, pi90>=34, pi91>=33, pi92>=32, pi93>=31, pi94>=30, pi95>=29, pi96>=28, pi97>=27, pi98>=26, pi99>=25, pi100>=24, pi101>=23, pi102>=22, pi103>=21, pi104>=20, pi105>=19, pi106>=18, pi107>=17, pi108>=16, pi109>=15, pi110>=14, pi111>=13, pi112>=12, pi113>=11, pi114>=10, pi115>=9, pi116>=8, pi117>=7, pi118>=6, pi119>=5, pi120>=4, pi121>=3, pi122>=2, pi123>=1, pi124>=0, pi125>=1, pi126>=2, pi127>=3, pi128>=4, pi129>=5, pi130>=6, pi131>=7, pi132>=8, pi133>=9, pi134>=10, pi135>=11, pi136>=12, pi137>=13, pi138>=14, pi139>=15, pi140>=16, pi141>=17, pi142>=18, pi143>=19, pi144>=20, pi145>=21, pi146>=22, pi147>=23, pi148>=24, pi149>=25, pi150>=26, pi151>=27, pi152>=28, pi153>=29, pi154>=30, pi155>=31, pi156>=32, pi157>=33, pi158>=34, pi159>=35, pi160>=36, pi161>=37, pi162>=38, pi163>=39, pi164>=40, pi165>=41, pi166>=42, pi167>=43, pi168>=44, pi169>=45, pi170>=46, pi171>=47, pi172>=48, pi173>=49, pi174>=50, pi175>=51, pi176>=52, pi177>=53, pi178>=54, pi179>=55, pi180>=56, pi181>=57, pi182>=58, pi183>=59, pi184>=60, pi185>=61, pi186>=62, pi187>=63, pi188>=64, pi189>=65, pi190>=66, pi191>=67, pi192>=68, pi193>=69, pi194>=70, pi195>=71, pi196>=72, pi197>=73, pi198>=74, pi199>=75, pi200>=76, pi201>=77, pi202>=78, pi203>=79, pi204>=80, pi205>=81, pi206>=82, pi207>=83, pi208>=84, pi209>=85, pi210>=86, pi211>=87, pi212>=88, pi213>=89, pi214>=90, pi215>=91, pi216>=92, pi217>=93, pi218>=94, pi219>=95, pi220>=96, pi221>=97, pi222>=98, pi223>=99, pi224>=100, pi225>=101, pi226>=102, pi227>=103, pi228>=104, pi229>=105, pi230>=106, pi231>=107, pi232>=108, pi233>=109, pi234>=110, pi235>=111, pi236>=112, pi237>=113, pi238>=114, pi239>=115, pi240>=116, pi241>=117, pi242>=118, pi243>=119, pi244>=120, pi245>=121, pi246>=122, pi247>=123, pi248>=124, 
