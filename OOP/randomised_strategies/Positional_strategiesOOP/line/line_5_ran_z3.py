...
pi0 = Real('pi0') # valor esperado de llegar al goal desde el estado 0
pi1 = Real('pi1')
pi2 = Real('pi2')
pi3 = Real('pi3')
pi4 = Real('pi4')
...
# Probabilities of going left or right in each state
# ex: strategy / colour 1 left = xo1l
xo1l = Real('xo1l')
xo1r = Real('xo1r')
xo2l = Real('xo2l')
xo2r = Real('xo2r')
...
# ys01 (estado 0 marcado con color 1), xo1l (probabilidad de izquierda con la estrategia del color 1)
pi0 == (ys01*xo1l+ ys02*xo2l)*(1 + pi0) + (ys01*xo1r+ ys02*xo2r)*(1 + pi1), 
pi1 == (ys11*xo1l+ ys12*xo2l)*(1 + pi0) + (ys11*xo1r+ ys12*xo2r)*(1 + pi2),
pi2 == 0,  # already in goal state
